...
const features: featureProps[] = [
	...
	},
	{
		...
		description: 'Monitor your progress and achievements with detailed analytics and personalized feedback.',
		icon: '📈',
	},
	{
		title: 'Community Support',
		description: 'Join a vibrant community of learners and instructors to share knowledge and support each other.',
		icon: '🤝',
	},
];
